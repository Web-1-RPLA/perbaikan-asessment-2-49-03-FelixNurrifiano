...
<body>
    ...
    <div class="content">
        ...
        <div class="menu-reservasi">
            <a href="index.php" class="btn-link">← Kembali ke Home</a>
            <a href="tambahreservasi.php" class="btn-link" style="background-color: #00a4f0; color: white; border-color: #00a4f0;">+ Tambah Reservasi Baru</a>
        </div>

        <?php
        $query = "SELECT r.id, t.nama AS nama_tamu, k.nomor_kamar, r.tanggal_checkin, r.tanggal_checkout, r.status 
                  FROM reservasi r
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td style='text-align: center;'>
                        <a href='hapusreservasi.php?id=" . $row['id'] . "' class='action-btn hapus-btn' onclick='return confirm(\"Apakah Anda yakin ingin menghapus transaksi reservasi ini?\")'>Hapus</a>
                      </td>";
                echo "</tr>";
            }
            echo "</table>";
        } else {
            echo "<div class='pesan-kosong'>Belum ada data reservasi di database.</div>";
        }
        ?>
    </div>
